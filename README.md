...
Step 2
 ...
 install livewire ==> php artisan jetstream:install livewire
 npm install
 npm run dev
...
Step 4 : create google OAuthCredentials

Add into config/services.php
...
change migration and model
create route
create controller
change login blade file